...
$$
\boldsymbol\beta \mid \cdot \sim \mathcal{N}\bigg(\big(\boldsymbol{X'X} + \frac{\sigma^2}{\tau^2}\boldsymbol I~\big)^{-1}~\boldsymbol{X'y}, ~\big(~\frac{1}{\sigma^2}(\boldsymbol{X'X})+ \frac{1}{\tau^2}\boldsymbol I~\big)^{-1}\bigg)
$$
...
This is a p-variate normal distribution with mean $\big[~(\boldsymbol{X'X})^{-1} + \frac{\sigma^2}{\tau^2}\boldsymbol I~\big]^{-1}~\boldsymbol{X'y}$ and covaraince matrix $~\big(~\frac{1}{\sigma^2}(\boldsymbol{X'X})^{-1} + \frac{1}{\tau^2}\boldsymbol I~\big)^{-1}$.
